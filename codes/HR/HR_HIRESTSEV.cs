...
namespace ASPNETCoreWeb.codes.HR
{
    ...
    public class HR_HIRESTSEV : WebGridEV
    {
        public HR_HIRESTSEV()
        {
            MyPageType = "HR_HIRESTS";
        }

        public override void InitialViewData()
        {
            string InitValue = "HIRESTS";
            ...
            string SSQL = " Select CODE,SNO,SD01,SD02,SD03 from XysOption  where CODE=N'HIRESTS' and SNO = N'" + PartialData + "' ";
