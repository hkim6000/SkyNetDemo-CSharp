...
{
    public class HR_SITETYPEMV : WebGridMV
    {
        public HR_SITETYPEMV()
        {
            SQLGridPage = this.GetType().Name;
            SQLGridFilter = "CODE=N'SITETYPE' and CODE+SD01+SD02+SD03+SD04+SD05+SD06+SD07";
            ...
            UIGrid.Items.AddRange(new UIGrid.Item[] {
                ...
                new UIGrid.Item { Name = "SD01", Label = "typename" },
