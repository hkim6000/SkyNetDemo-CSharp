...
namespace ASPNETCoreWeb.codes.HR
{
    ...
    public class HR_EMPSTSEV : WebGridEV
    {
        public HR_EMPSTSEV()
        {
            MyPageType = "HR_EMPSTS";
        }

        public override void InitialViewData()
        {
            string InitValue = "EMPSTS";
            ...
            string SSQL = " Select CODE,SNO,SD01,SD02,SD03 from XysOption  where CODE=N'EMPSTS' and SNO = N'" + PartialData + "' ";
