...
namespace ASPNETCoreWeb.codes.HR
{
    ...
    public class HR_MNGTITEV : WebGridEV
    {
        public HR_MNGTITEV()
        {
            MyPageType = "HR_MNGTIT";
        }

        public override void InitialViewData()
        {
            string InitValue = "MNGTIT";
            ...
            string SSQL = " Select CODE,SNO,SD01,SD02,SD03 from XysOption  where CODE=N'MNGTIT' and SNO = N'" + PartialData + "' ";
