...
namespace ASPNETCoreWeb.codes.HR
{
    ...
    public class HR_WAGETYPEEV : WebGridEV
    {
        public HR_WAGETYPEEV()
        {
            MyPageType = "HR_WAGETYPE";
        }

        public override void InitialViewData()
        {
            string InitValue = "WAGETYPE";
            ...
            new UIControl.Item { Name = "SD01", Label = "typename", Styles = "width:250px;", Attributes = "maxlength:50;", IsRequired = true, LineSpacing = 10 },
            new UIControl.Item { Name = "SD03", Label = "inuse", UIType = UITypes.Checkbox, InitialValues = InitValue1, LineSpacing = 20 }
            });

            string SSQL = " Select  CODE,SNO,SD01,SD02,SD03 from XysOption  where CODE=N'WAGETYPE' and SNO = N'" + PartialData + "' ";
        ...
        protected override string PutSaveData()
        {
            ...
            SqlParams.Add(new SqlParameter { ParameterName = "@SD02", Value = string.Empty, SqlDbType = SqlDbType.NVarChar });
