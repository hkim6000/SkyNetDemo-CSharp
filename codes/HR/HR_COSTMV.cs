...
namespace ASPNETCoreWeb.codes.HR
{
    ...
    public class HR_COSTMV : WebGridMV
    {
        public HR_COSTMV()
        {
            SQLGridPage = typeof(HR_COSTMV).ToString();
            SQLGridFilter = "CODE=N'COSTCT' and CODE+SD01+SD02+SD03+SD04+SD05+SD06+SD07";
            ...
            SQLGridInfo.Id = typeof(HR_COSTMV).ToString();
