...
namespace ASPNETCoreWeb.codes.HR
{
    ...
    public class HR_COSTEV : WebGridEV
    {
        public HR_COSTEV()
        {
            MyPageType = "HR_COST";
        ...
        public override void InitialViewData()
        {
            ...
            string SSQL = " Select CODE,SNO,SD01,SD02,SD03 from XysOption  where CODE=N'COSTCT' and SNO = N'" + PartialData + "' ";
