...
namespace ASPNETCoreWeb.codes.HR
{
    ...
    public class HR_EMPSTSMV : WebGridMV
    {
        public HR_EMPSTSMV()
        {
            SQLGridPage = typeof(HR_EMPSTSMV).ToString();
            SQLGridFilter = "CODE=N'EMPSTS' and CODE+SD01+SD02+SD03+SD04+SD05+SD06+SD07";
            ...
            SQLGridInfo.Id = typeof(HR_EMPSTSMV).ToString();
