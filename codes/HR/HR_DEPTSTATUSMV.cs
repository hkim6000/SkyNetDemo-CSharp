...
namespace ASPNETCoreWeb.codes.HR
{
    ...
    public class HR_DEPTSTATUSMV : WebGridMV
    {
        public HR_DEPTSTATUSMV()
        {
            SQLGridPage = this.GetType().Name;
            SQLGridFilter = "CODE=N'DEPTSTATUS' and CODE+SD01+SD02+SD03+SD04+SD05+SD06+SD07";
            ...
            new UIGrid.Item { Name = "SD01", Label = "statusname" },
