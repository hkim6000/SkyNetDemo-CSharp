...
namespace ASPNETCoreWeb.codes.HR
{
    ...
    public class HR_DEPTSTATUSEV : WebGridEV
    {
        public HR_DEPTSTATUSEV()
        {
            MyPageType = "HR_DEPTSTATUS";
        }

        public override void InitialViewData()
        {
            string InitValue = "DEPTSTATUS";
            ...
            ViewPart.UIControl.Set(new UIControl.Item[] {
                ...
                new UIControl.Item { Name = "SD01", Label = "statusname", Styles = "width:250px;", Attributes = "maxlength:50;", IsRequired = true, LineSpacing = 10 },
            ...
            string SSQL = " Select CODE,SNO,SD01,SD02,SD03 from XysOption  where CODE=N'DEPTSTATUS' and SNO = N'" + PartialData + "' ";
