...
namespace ASPNETCoreWeb.codes.HR
{
    ...
    public class HR_SITETYPEEV : WebGridEV
    {
        public HR_SITETYPEEV()
        {
            MyPageType = "HR_SITETYPE";
        }

        public override void InitialViewData()
        {
            string InitValue = "SITETYPE";
            ...
            string SSQL = " Select  CODE,SNO,SD01,SD02,SD03 from XysOption  where CODE=N'SITETYPE' and SNO = N'" + PartialData + "' ";
